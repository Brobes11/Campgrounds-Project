...
public class JDBCEmployeeDAOTest {
	...
	private static final long TEST_EMPLOYEE_DEPT_ID = 1;
	...
	public void setup() {
		...
		//test.update("INSERT INTO department(department_id, name) VALUES (1, 'Test Department');");
	}
	...
	public void findEmployeeByDepartmentId_finds_correct_employee() {
		...
		jdbcTemplate.update("INSERT INTO employee (department_id, first_name, last_name, birth_date, hire_date, gender) VALUES (?, ?, ?, ?, ?, ?);",
				TEST_EMPLOYEE_DEPT_ID, TEST_EMPLOYEE_FIRST_NAME, TEST_EMPLOYEE_LAST_NAME, TEST_EMPLOYEE_BIRTHDAY, TEST_EMPLOYEE_STARTDATE, TEST_EMPLOYEE_GENDER);
